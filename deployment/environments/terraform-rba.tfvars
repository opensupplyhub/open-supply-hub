...
reassert_promotions_enabled       = true                # Runs when the sync above succeeds, not on a clock.
...
contribot_slack_failures_api_url_secret_name = "oshub/rba/contribot-slack-failures-api-url"
