...
locals {
  ...
  ecs_secretsmanager_secret_arns = compact([
    ...
    local.google_analytics_key_arn,
    local.google_service_account_creds_base64_arn,
    local.rollbar_server_side_access_token_arn,
    local.rollbar_client_side_access_token_arn,
    local.oar_client_key_arn,
    local.hubspot_api_key_arn,
    local.stripe_secret_key_arn,
    local.stripe_webhook_secret_arn,
    local.dark_visitors_token_arn,
    local.dark_visitors_project_key_arn,
    local.dromo_license_key_arn,
