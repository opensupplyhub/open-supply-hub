...
| v1.13.0 | June 01, 2024  | May 30, 2024 | @Vadim Kovalenko |
...
1. Code freeze occurs every Monday in the second week of new release version development. To enhance communication within the team, all stakeholders must be notified about the code freeze two working days before the code freeze by the responsible person for the release.
2.  On the day of the code freeze, the responsible person has to verify that the pre-prod environment is up and running.
