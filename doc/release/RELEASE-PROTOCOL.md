...
7. Once the pre-prod environment is no longer needed for testing the release candidate, shut it down using the `Destroy Environment` GitHub workflow, as it is no longer required for the current version of the release.
