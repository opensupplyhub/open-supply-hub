...
#### Schema changes
* [OSDEV-3510](https://opensupplyhub.atlassian.net/browse/OSDEV-3510) - `api_moderationevent.claim_id` loses its unique constraint (one-to-one → foreign key). No new tables or columns.
