...
* [OSDEV-2789](https://opensupplyhub.atlassian.net/browse/OSDEV-2789) - Updated data submission confirmation emails for claims, SLCs, and list uploads to reflect the new data moderation pause SLAs, hidden behind the enable_moderation_pause_info switch.
