...
* [OSDEV-2924](https://opensupplyhub.atlassian.net/browse/OSDEV-2924) - Floated `js-yaml` (3.15.1 / 4.3.1, GHSA-5p4m-2wfm-xmqj) and `postcss` (8.5.26, CVE-2026-69153) up within their existing ranges via `yarn.lock` only — no new `resolutions` pins, as both consumers already accepted the patched versions.
