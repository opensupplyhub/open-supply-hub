...
* [OSDEV-2318](https://opensupplyhub.atlassian.net/browse/OSDEV-2318) - Updated Terraform version from `1.5` to `1.13.3`. Upgraded Kafka from `3.4.0` to `3.9.0` to align with the current AWS MSK supported version.
