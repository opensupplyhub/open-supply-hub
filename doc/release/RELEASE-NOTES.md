...
* [OSDEV-1178](https://opensupplyhub.atlassian.net/browse/OSDEV-1178) - Make follow-up fix for the "Something went wrong" error after clicking on Dashboard -> View Facility Claims.
