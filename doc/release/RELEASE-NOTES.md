...
* [OSDEV-2924](https://opensupplyhub.atlassian.net/browse/OSDEV-2924) - The Reject Moderation Event dialog has a new rich-text editor (Quill). The toolbar gains strikethrough, blockquote, code block, sub/superscript, a font selector (including monospace), header levels 1-6, and an RTL text-direction toggle, and the typing area now fills the dialog instead of leaving dead space. The rejection flow and stored data are unchanged.
