...
* `0228_create_facility_processing_value_index.py` - Adds trigger-maintained case-insensitive facility and processing type value aggregates, including distinct-location counts and submitted-casing variants used by processing type suggestions. See OSDEV-3189.
