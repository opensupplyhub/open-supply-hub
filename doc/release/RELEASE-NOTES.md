...
### What's new
* [OSDEV-1764](https://opensupplyhub.atlassian.net/browse/OSDEV-1764) - Added a new email for the Moderation queue/SLC workflow to send a claiming email to the customer after a data moderator creates a new location based on the moderation event they submitted.
