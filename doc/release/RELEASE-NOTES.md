...
### Bugfix
* [OSDEV-996](https://opensupplyhub.atlassian.net/browse/OSDEV-996) The default sorting order for embedded maps was broke(changed to Descending by # Contributors). The default sorting order for embedded maps has been fixed - changed it back to Ascending by Name.
