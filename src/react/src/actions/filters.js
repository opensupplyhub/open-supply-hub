...
export const clearCountryFilter = createAction('CLEAR_COUNTRY_FILTER');
...
export const updateCombinePartnerContributorsFilterOption = createAction(
    'UPDATE_COMBINE_PARTNER_CONTRIBUTORS_FILTER_OPTION',
);
