...
export const productionLocationPropType = shape({
    os_id: string.isRequired,
    name: string.isRequired,
    local_name: string.isRequired,
    description: string.isRequired,
    address: string.isRequired,
    business_url: string.isRequired,
    sector: arrayOf(string).isRequired,
    parent_company: string.isRequired,
    product_type: arrayOf(string).isRequired,
    location_type: arrayOf(string).isRequired,
    processing_type: arrayOf(string).isRequired,
    ...
    minimum_order_quantity: string.isRequired,
    average_lead_time: string.isRequired,
    percent_female_workers: number.isRequired,
    affilitations: arrayOf(string).isRequired,
    certifications_standards_regulations: arrayOf(string).isRequired,
    country: shape({
        name: string.isRequired,
