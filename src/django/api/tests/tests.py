...
from api.models import (
    ...
    NonstandardField,
    RequestLog,
    # Comment out this import as it is used in tests related to matching,
    # and those tests are currently commented out.
    # Sector,
    Source,
    User,
    DynamicSetting,
    ...
    def test_is_referer_allowed(self):
        def check_host(url):
            return referring_host_is_allowed(
                referring_host(PermissionsTests.MockRequest(url))
            )
