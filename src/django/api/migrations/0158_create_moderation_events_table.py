# Generated by Django 3.2.17 on 2024-10-17 11:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_change_date', models.DateTimeField(auto_now=True, help_text='Date when the moderation decision was made.')),
                ('request_type', models.CharField(choices=[('CREATE', 'Create'), ('UPDATE', 'Update'), ('CLAIM', 'Claim')], help_text='Type of moderation record type.', max_length=200)),
