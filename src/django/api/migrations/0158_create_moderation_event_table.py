# Generated by Django 3.2.17 on 2024-10-22 10:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_change_date', models.DateTimeField(blank=True, help_text='Date when the moderation decision was made.')),
                ...
                ('source', models.CharField(blank=True, choices=[('API', 'API'), ('SLC', 'SLC')], help_text='Source type of production location. If request_type is CLAIM, no source type.', max_length=3)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='moderationevent',
            name='contributor',
            field=models.ForeignKey(help_text='Linked contributor responsible for this moderation event.', on_delete=django.db.models.deletion.CASCADE, related_name='moderation_event', to='api.contributor'),
        ),
    ]
