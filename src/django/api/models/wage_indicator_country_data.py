...
WAGE_INDICATOR_LINK_TEXTS_CACHE_KEY = "wage_indicator_link_texts"
...
class WageIndicatorCountryData(Model):
    ...
    def get_links_with_text(self):
        ...
        """
        link_texts = cache.get(WAGE_INDICATOR_LINK_TEXTS_CACHE_KEY)
        ...
        if link_texts is None:
            ...
            cache.set(
                WAGE_INDICATOR_LINK_TEXTS_CACHE_KEY,
                link_texts,
                3600,
            )
    ...
    def get_links_for_country(cls, country_code):
        ...
        try:
            ...
            logger.warning(
                f"WI links not found for country code: {country_code}",
            )
            return []
