...
def serialize_params(serializer_class, query_params):
    ...
    for key, value in query_params.lists():
        ...
        if key in [
            ...
            f'{V1_PARAMETERS_LIST.ADDITIONAL_IDENTIFIERS}[rba_id]',
            f'{V1_PARAMETERS_LIST.ADDITIONAL_IDENTIFIERS}[duns_id]',
            f'{V1_PARAMETERS_LIST.ADDITIONAL_IDENTIFIERS}[lei_id]',
        ]:
