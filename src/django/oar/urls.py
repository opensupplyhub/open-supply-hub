...
public_apis = [
    ...
    path('api/processing-type-suggestions/',
         views.ProcessingTypeSuggestionsView.as_view(),
         name='processing_type_suggestions'),
...
internal_apis = [
    ...
    path('user-profile/<int:pk>/facility-lists/',
         views.UserProfileFacilityLists.as_view(),
         name='user_profile_facility_lists'),
    path('user-profile/<int:pk>/facilities/',
         views.UserProfileFacilities.as_view(),
         name='user_profile_facilities'),
