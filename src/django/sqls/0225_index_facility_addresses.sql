CREATE OR REPLACE
FUNCTION index_facility_addresses(af_id TEXT)
RETURNS TABLE (facility_address json)
LANGUAGE plpgsql
AS $Body$
BEGIN
	RETURN QUERY
SELECT
	...
	'created_at',
	af2.created_at,
	'is_from_created_from',
	COALESCE(
		(af2.id = (
			SELECT af.created_from_id
	...
	'is_anonymized',
	COALESCE(as2.is_anonymized, false),
	'contributor',
	json_build_object(
		'id',
	ac.id,
