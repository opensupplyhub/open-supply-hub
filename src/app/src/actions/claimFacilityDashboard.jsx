...
export const startDownloadFacilityClaims = createAction(
    'START_DOWNLOAD_FACILITY_CLAIMS',
);

export const failDownloadFacilityClaims = createAction(
    'FAIL_DOWNLOAD_FACILITY_CLAIMS',
);

export const completeDownloadFacilityClaims = createAction(
    'COMPLETE_DOWNLOAD_FACILITY_CLAIMS',
);

export function downloadFacilityClaims(data) {
    return dispatch => {
        dispatch(startDownloadFacilityClaims());
        try {
            downloadFacilityClaimsXLSX(data);
            dispatch(completeDownloadFacilityClaims());
        } catch (err) {
            dispatch(
                logErrorAndDispatchFailure(
                    err,
                    'An error prevented downloading that facility claims',
